...
- `_render_ndi_frame_image(self) -> QImage` [method] (pyssp/ui/main_window/video_display.py:931)
- `_ndi_audio_players(self) -> List[ExternalMediaPlayer]` [method] (pyssp/ui/main_window/video_display.py:953)
- `_ndi_sender_has_receivers(self) -> bool` [method] (pyssp/ui/main_window/video_display.py:990)
- `_ndi_audio_output_block_frames(self) -> int` [method] (pyssp/ui/main_window/video_display.py:996)
- `_ndi_audio_target_frames(self, sample_rate: int) -> int` [method] (pyssp/ui/main_window/video_display.py:1014)
- `_ndi_audio_send_silence_keepalive(self, sender: object, *, sample_rate: int, channel_count: int) -> bool` [method] (pyssp/ui/main_window/video_display.py:1018)
- `_configure_ndi_sender(self) -> bool` [method] (pyssp/ui/main_window/video_display.py:1035)
- `_send_ndi_audio(self) -> None` [method] (pyssp/ui/main_window/video_display.py:1063)
- `_refresh_ndi_output(self, force: bool = False) -> None` [method] (pyssp/ui/main_window/video_display.py:1125)
- `_tick_ndi_refresh(self) -> None` [method] (pyssp/ui/main_window/video_display.py:1135)
- `_tick_ndi_audio_refresh(self) -> None` [method] (pyssp/ui/main_window/video_display.py:1138)
- `_apply_video_frame_to_targets(self) -> None` [method] (pyssp/ui/main_window/video_display.py:1143)
- `_clear_video_frame_runtime(self, preserve_current_frame: bool = False) -> None` [method] (pyssp/ui/main_window/video_display.py:1153)
- `_queue_video_frame_refresh(self, *, force: bool = False) -> None` [method] (pyssp/ui/main_window/video_display.py:1175)
- `_tick_video_refresh(self) -> None` [method] (pyssp/ui/main_window/video_display.py:1251)
- `_on_video_frame_ready(self) -> None` [method] (pyssp/ui/main_window/video_display.py:1256)
- `_on_video_frame_decoded(self, tag: int, path: str, bucket_ms: int, width: int, height: int, payload: bytes) -> None` [method] (pyssp/ui/main_window/video_display.py:1268)
- `_refresh_video_display(self, force: bool = False) -> None` [method] (pyssp/ui/main_window/video_display.py:1328)
- `_slot_or_media_has_audio(self, slot: Optional[SoundButtonData]) -> bool` [method] (pyssp/ui/main_window/video_display.py:1344)
- `_silent_video_source_payload(self, slot: SoundButtonData) -> Optional[dict]` [method] (pyssp/ui/main_window/video_display.py:1356)
