...
ndi_datas, ndi_binaries, ndi_hiddenimports = collect_all("cyndilib")
...
a = Analysis(
    ...
    hiddenimports=pedalboard_hiddenimports + pedalboard_native_hiddenimports + ndi_hiddenimports + ['pedalboard_native', 'cyndilib'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
