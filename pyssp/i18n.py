...
_TRANSLATIONS = {
    LANG_ZH_CN: {
        ...
        "1. Build the timeline here. Select a cue or lyric row, then edit the selected cue just below in this same panel.": "1. 在这里建立时间线。选择一个 Cue点或歌词行，然后直接在下方同一面板中编辑所选 Cue点。",
