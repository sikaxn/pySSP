...
_TRANSLATIONS = {
    LANG_ZH_CN: {
        ...
        "Audio Device & Timecode": "音频设备与时间码",
        "Talk": "讲话闪避",
        "Web Remote": "网页遥控",
        "Drag blocks to move buttons. Drag bottom-right corner to resize. Layout is snapped to the grid.": "拖动方块可移动按钮。拖动右下角可调整大小。布局会自动吸附到网格。",
        "Main Buttons (4 x 4)": "主按钮（4 x 4）",
        "Fade Buttons (3 x 1)": "淡变按钮（3 x 1）",
        "Available Buttons": "可用按钮",
        "Show all buttons": "显示全部按钮",
        "Clear All": "全部清空",
        "Button Overlap": "按钮重叠",
        "Destination is already occupied.": "目标位置已被占用。",
        "Choose action:": "请选择操作：",
        "Swap": "交换",
        "Copy": "复制",
        ...
        "Now Playing Display": "正在播放显示",
        "Show Caption (Default)": "显示标题（默认）",
        "Show File Name": "显示文件名",
        "Show File Name with Full Path": "显示完整路径文件名",
        "Show Notes": "显示备注",
        "Show Caption with Notes": "显示标题和备注",
        "UI Language": "界面语言",
        ...
        "Loading main window...": "正在加载主窗口...",
        "Build:": "构建:",
        "Getting Started": "快速开始",
        "Welcome to pySSP": "欢迎使用 pySSP",
        "Python Sports Sounds Pro": "Python Sports Sounds Pro",
        ...
        "Add a Page and Load a Sound": "添加页面并载入声音",
        "To start, add a page, then drag a file to a sound button to add sound.": "开始使用时，先添加一个页面，然后把文件拖到声音按钮上来添加声音。",
        "Alternatively, open an existing SSP .set file to bring in your current pages and buttons.": "或者，你也可以打开现有的 SSP `.set` 文件，把当前页面和按钮一起带进来。",
        "Compatibility warning: not all pySSP features are supported by the original SSP. If you move sets back to the original SSP, some pySSP-specific settings or behavior may not carry over.": "兼容性提醒：原版 SSP 不支持 pySSP 的全部功能。如果你把集合再移回原版 SSP，一些 pySSP 专用设置或行为可能无法保留。",
        "1. Add a page": "1. 添加页面",
        "2. Drag file to sound button": "2. 把文件拖到声音按钮",
        "Set the Audio Output Device": "设置音频输出设备",
        "Set the audio output device under Setup > Options > Audio Device & Timecode.": "请在“设置 > 选项 > 音频设备与时间码”中设置音频输出设备。",
        "Open Audio Device Options": "打开音频设备选项",
        "You're Ready": "可以开始了",
        "Use the links below to open release notes, docs, options, or license info any time.": "你可以随时使用下面的链接打开发行说明、文档、选项或许可证信息。",
        "Get Latest Version / Release Log": "获取最新版本 / 查看发行日志",
        "Open Docs": "打开文档",
        "Open Options": "打开选项",
        "Open About / License": "打开关于 / 许可证",
        "Page {current} of {total}": "第 {current} 页，共 {total} 页",
        "Beta Version": "测试版",
        "You are using a beta version. Use with caution.": "你正在使用测试版，请谨慎使用。",
        "Beta build - use with caution": "测试版构建 - 请谨慎使用",
        "Edit Sound Button": "编辑声音按钮",
        "Lyric Editor": "歌词编辑器",
        "Lyric Editor...": "歌词编辑器...",
        "Reveal File in File Browser": "在文件浏览器中显示文件",
        "Reveal Sound File in File Browser": "在文件浏览器中显示声音文件",
        "Reveal Sound File": "显示声音文件",
        "Sound file does not exist:\n{path}": "声音文件不存在:\n{path}",
        "Lyric File Found": "发现歌词文件",
        "Matching lyric files were found. Check whether to link each lyric file.": "已找到匹配的歌词文件。请勾选是否链接每个歌词文件。",
        "Audio File": "音频文件",
        "Title": "标题",
        "Filename": "文件名",
        "Link": "链接",
        "(not found)": "（未找到）",
        "Generated File": "生成文件",
        "Generated Name": "生成文件名",
        "Vocal Removed File Found": "找到的人声移除文件",
        "Generate": "生成",
        "Select All Eligible": "全选可用项",
        "Unselect All": "取消全选",
        "Link All Found": "全部链接已找到项",
        "Unlink All": "全部取消链接",
        ...
        "Show Lyric": "显示歌词",
        "Blank Lyric": "黑场歌词",
        "Open / Hide Lyric Navigator": "打开/隐藏歌词导航器",
        "Lyric": "歌词",
        "Audio Format": "音频格式",
        "Audio Loading & Format": "音频加载与格式",
        "Timestamp": "时间戳",
        "Main UI Lyric Display": "主界面歌词显示",
        "Always": "始终显示",
        "When Lyric Available": "有歌词时显示",
        "Never": "从不显示",
        "Lyric Link": "歌词关联",
        "Search lyric file when adding sound button": "添加声音按钮时搜索歌词文件",
        "Default format for new lyric file:": "新歌词文件默认格式:",
        "Rapid Editor": "快速编辑器",
        "Highlight now playing lyric (follow playhead)": "高亮当前播放歌词（跟随播放头）",
        "Add Line At Current Timestamp": "在当前时间戳添加行",
        "Delete Selected Line": "删除所选行",
        "Expand Rapid Editor": "展开快速编辑器",
        "Collapse Rapid Editor": "收起快速编辑器",
        "Paste lyric lines here, one line per row...": "在此粘贴歌词内容，每行一条...",
        "Insert Line At Current Timestamp": "在当前时间戳插入歌词行",
        "Insert Blank At Current Timestamp": "在当前时间戳插入空白行",
        "Replace This Line With Blank": "将当前行替换为空白",
        "Select a lyric row first.": "请先选择一行歌词。",
        "Undo": "撤销",
        "Invalid timestamp at row {row}.": "第 {row} 行时间戳无效。",
        "Rapid editor is empty.": "快速编辑器为空。",
        "Failed to save lyric file:": "保存歌词文件失败:",
        "Browse": "浏览",
        "Regenerate": "重新生成",
        "File": "文件",
        "Caption": "标题",
        "Notes": "备注",
        "Vocal Removed File": "去人声文件",
        "Lyric File": "歌词文件",
        "Clear": "清除",
        "Sound Button Hot Key": "声音按钮快捷键",
        "Sound Button MIDI Hot Key": "声音按钮 MIDI 热键",
        "Use custom playback volume": "使用自定义播放音量",
        "Playback Volume": "播放音量",
        "Select Sound File": "选择声音文件",
        "Select Vocal Removed File": "选择去人声文件",
        "Select Lyric File": "选择歌词文件",
        "Lyric Files (*.lrc *.srt);;All Files (*.*)": "歌词文件 (*.lrc *.srt);;所有文件 (*.*)",
        ...
        "You did not link a lyric. Create a lyric file now?": "你没有链接歌词。现在创建歌词文件吗？",
        "This sound has no lyric linked. Create a lyric file now?": "此声音未链接歌词。现在创建歌词文件吗？",
        "Create Lyric File": "创建歌词文件",
        "Failed to create lyric file:": "创建歌词文件失败:",
        "Linked lyric file does not exist:\n{path}\n\nCreate this file now?": "已链接的歌词文件不存在:\n{path}\n\n现在创建该文件吗？",
        "DSP": "DSP",
        "10-Band EQ": "10 段均衡器",
        "EQ On": "均衡器开",
        "EQ Off": "均衡器关",
        ...
        "Show Display": "显示舞台屏",
        "Show Stage Display": "显示舞台显示",
        "Stage Display Setting": "舞台显示设置",
        "Stage display setting": "舞台显示设置",
        "Send Alert": "发送通知",
        "Open Lyric Display": "打开歌词显示",
        "Open Web Remote": "打开网页遥控",
        "Web Lyric Display": "网页歌词显示",
        "Overhead": "顶投",
        "Banner": "横幅",
        "vMix Overlay": "vMix 叠加",
        "Timecode Panel": "时间码面板",
        "Duplicate Check": "重复检查",
        "Show Colour Legend": "显示颜色图例",
        "Verify Sound Buttons": "验证声音按钮",
        "Bulk Generate Vocal Removed Track": "批量生成人声移除音轨",
        "Bulk Generate Vocal Removed Tracks": "批量生成人声移除音轨",
        "Select which sound buttons to generate. Generated files will be saved automatically beside the source audio file using the *_pyssp_vocal_removal* filename pattern. No save location prompt is shown.": "选择要生成的声音按钮。生成的文件会自动保存在源音频文件旁边，并使用 *_pyssp_vocal_removal* 文件名模式。不会弹出保存位置提示。",
        "Link Unlinked Vocal Removed Track": "关联未链接的人声移除音轨",
        "Link Unlinked Vocal Removed Tracks": "关联未链接的人声移除音轨",
        "Unlink All Vocal Removed Track": "取消关联全部人声移除音轨",
        "Disable Play List on All Pages": "禁用所有页面播放列表",
        "Reset All Pages": "重置所有页面",
        ...
        "Launchpad Cheat Sheet": "Launchpad 对照表",
        "View Log": "查看日志",
        "About": "关于",
        "Help": "帮助",
        ...
        "Next Page": "下一页面",
        "Previous Page": "上一页面",
        "Next Sound Button": "下一声音按钮",
        "Previous Sound Button": "上一声音按钮",
        "X (Cross Fade)": "X（交叉淡化）",
        "Mute": "静音",
        "Volume Up": "音量增大",
        "Volume Down": "音量减小",
        ...
        "Cue It": "加入 Cue",
        "Set Cue Points...": "设置 Cue 点...",
        "Timecode Setup...": "时间码设置...",
        "Timecode Setup": "时间码设置",
        "Offset": "偏移",
        "Respect global setting": "遵循全局设置",
        "Relative to actual audio file": "相对于实际音频文件",
        "Relative to cue set point": "相对于 Cue 设定点",
        "Enable soundbutton timecode offset": "启用声音按钮时间码偏移",
        "Respect soundbutton timecode display timeline setting": "遵循声音按钮时间码显示时间线设置",
        "+1s": "+1秒",
        "-1s": "-1秒",
        ...
        "Reset all pages' played state?": "重置所有页面的已播放状态？",
        "Button Drag": "按钮拖拽",
        "Replace": "替换",
        "Swap": "交换",
        ...
        "Launchpad input disconnected:": "Launchpad 输入已断开：",
        "Launchpad output disconnected:": "Launchpad 输出已断开：",
        "Launchpad input reconnected:": "Launchpad 输入已重新连接：",
        "Launchpad output reconnected:": "Launchpad 输出已重新连接：",
        "Configure MTC output in Audio Device / Timecode.": "请在“音频设备 / 时间码”中配置 MTC 输出。",
        "Configure MTC output in Audio Device & Timecode.": "请在“音频设备与时间码”中配置 MTC 输出。",
        ...
        "Rotary learn: turn encoder forward several ticks, then backward several ticks.": "旋钮学习：先向前转动编码器数次，再向后转动数次。",
        "Rotary learn: now turn backward several ticks.": "旋钮学习：现在请向后转动数次。",
        "Rotary learn complete. Relative mode: {mode}.": "旋钮学习完成。相对模式：{mode}。",
        "Rotary learn complete.": "旋钮学习完成。",
        ...
        "Fade During Vocal Removed / Original Track Conversion": "去人声/原曲切换时淡化",
        "Follow Cross Fade (X, use Cross Fade Seconds)": "跟随交叉淡化（X，使用交叉淡化秒数）",
        "Follow Cross Fade (X), but use custom seconds": "跟随交叉淡化（X），但使用自定义秒数",
        "Never fade": "从不淡化",
        "Always fade": "始终淡化",
        "sec": "秒",
        "Vocal Removed": "去人声",
        "Audio Engine Insight": "音频引擎洞察",
        ...
        "Audio Playback": "音频播放",
        "Audio Preload": "音频预加载",
        "Rescan Supported Audio Format": "重新扫描受支持音频格式",
        "Detected Supported Audio Format Extensions": "已检测到的受支持音频格式扩展名",
        "(none detected)": "（未检测到）",
        ...
        "Stop playback before rescanning supported audio formats.": "请先停止播放后再重新扫描受支持音频格式。",
        "Could not detect supported audio formats within 10 seconds.\n\nAllow other unsupported files for now?": "无法在 10 秒内检测到受支持的音频格式。\n\n是否暂时允许其他不受支持的文件？",
        "Behavior": "行为",
        ...
        "Clear waveform cache on every launch": "每次启动时清理波形缓存",
        "Current Cache Usage:": "当前缓存占用:",
        "Clear Waveform Cache": "清理波形缓存",
        "Open Settings Folder": "打开设置文件夹",
        "Waveform cache cleared.": "波形缓存已清理。",
        "Failed to clear waveform cache.": "清理波形缓存失败。",
        ...
        "Launchpad Device": "Launchpad 设备",
        "Launchpad device:": "Launchpad 设备:",
        "Launchpad output:": "Launchpad 输出:",
        "Grid layout:": "网格布局:",
        "Turn off Launchpad lights for empty sound buttons": "关闭空白声音按钮对应的 Launchpad 灯光",
        "The selected Launchpad is handled independently from the MIDI devices above.": "所选 Launchpad 与上方的 MIDI 设备独立处理。",
        "The 6-row sound area is mapped directly to Quick Action buttons 1-48. The remaining 2 rows are Launchpad-only controls. C9 defaults to Shift Layer; press C9 to toggle the sound-button area between normal mode and the second-layer display. Only C9 can open that layer, so assigning another action to C9 disables second-layer access.": "6 行声音区域会直接映射到快速触发按钮 1-48。其余 2 行是仅供 Launchpad 使用的控制区。C9 默认为切换层；按下 C9 可在普通模式与第二层显示之间切换声音按钮区域。只有 C9 能打开该层，因此若将其他操作分配给 C9，将禁用第二层访问。",
        "B pads are fixed sound-button pads. C pads are configurable Launchpad control pads with LED feedback. On the Shift layer, C1-C8 become the operation bar, C10 selects Master Volume, C11 selects Jog, C13 toggles absolute mode, and C14-C16 select relative sensitivity.": "B 区按垫为固定的声音按钮按垫。C 区按垫为可配置的 Launchpad 控制按垫，并带有 LED 反馈。在切换层中，C1-C8 为操作栏，C10 选择主音量，C11 选择 Jog，C13 切换绝对模式，C14-C16 选择相对灵敏度。",
        "Bottom 6 rows": "底部 6 行",
        "Top 6 rows": "顶部 6 行",
        "Launchpad Programmer Mode": "Launchpad 编程模式",
        "Launchpad": "Launchpad",
        "Normal Layer": "普通层",
        "Shift Layer": "切换层",
        "Offline Launchpad simulator. It uses the current Launchpad layout and saved control bindings, but does not require a Launchpad connection and does not send MIDI or LED messages.": "离线 Launchpad 模拟器。它使用当前 Launchpad 布局和已保存的控制绑定，但不需要连接 Launchpad，也不会发送 MIDI 或 LED 消息。",
        "Shift layer: C9 toggles the layer. C1-C8 are the operation bar. C10 selects Master Volume, C11 selects Jog, C13 toggles absolute mode, and C14-C16 set relative sensitivity.": "切换层说明：C9 用于切换层。C1-C8 为操作栏。C10 选择主音量，C11 选择 Jog，C13 切换绝对模式，C14-C16 设置相对灵敏度。",
        "Apply Launchpad MIDI Mapping": "应用 Launchpad MIDI 映射",
        "Launchpad layout:": "Launchpad 布局:",
        "This replaces Sound Button MIDI Hot Key values on the current page.": "这将替换当前页面上的“声音按钮 MIDI 热键”值。",
        "No assigned sound buttons on the current page.": "当前页面没有已分配的声音按钮。",
        "Idle Behavior:": "空闲行为:",
        ...
        "Bitfocus Companion is a button-based control and automation tool for production systems. Learn more at ": "Bitfocus Companion 是一个用于制作系统的按钮控制与自动化工具。更多信息请访问 ",
        "Use the Python SSP module in Companion when linking to pySSP.": "在 Companion 中连接 pySSP 时，请使用 Python SSP 模块。",
        "IP address: ": "IP 地址: ",
        "If Companion and pySSP are on the same computer, adding the module will usually work with the default settings.": "如果 Companion 和 pySSP 在同一台电脑上，直接添加该模块通常就可以使用默认设置正常工作。",
        ...
        "Web Remote is not enabled. Please enable Web Remote for {feature} to work.": "网页遥控未启用。请启用网页遥控后再使用{feature}。",
        "Mode must be show, blank, or toggle.": "模式必须是 show、blank 或 toggle。",
        ...
        "Select All": "全选",
        "Deselect All": "取消全选",
        "Pack pySSP Settings": "打包 pySSP 设置",
        "Pack lyric": "打包歌词",
        "Maintain directory structure": "保留目录结构",
        "pyssppak Location": "pyssppak 位置",
        "Unpack Directory": "解包目录",
        "Unpack lyric": "解包歌词",
        "Try restore setting if exist": "如果存在则尝试恢复设置",
        "Open unpack set file after unpack": "解包后打开 .set 文件",
        "Select pySSP Audio Library": "选择 pySSP 音频库",
        "pySSP Audio Library (*.pyssppak);;All Files (*.*)": "pySSP 音频库 (*.pyssppak);;所有文件 (*.*)",
        "Select Unpack Directory": "选择解包目录",
        "Packed:": "已打包:",
        "Skipped:": "已跳过:",
        "button(s)": "个按钮",
        "Export CSV": "导出 CSV",
        "CSV (*.csv);;All Files (*.*)": "CSV (*.csv);;所有文件 (*.*)",
        "Select at least one page to pack.": "请至少选择一个页面进行打包。",
        "Packing audio library...": "正在打包音频库...",
        "Verifying and packing": "正在验证并打包",
        "Processed": "已处理",
        "Packing": "正在打包",
        "Packing settings.ini...": "正在打包 settings.ini...",
        "Writing package manifest...": "正在写入包清单...",
        "Pack operation cancelled.": "打包操作已取消。",
        "Could not pack audio library:": "无法打包音频库:",
        "Select a valid pyssppak file.": "请选择有效的 pyssppak 文件。",
        "Select an unpack directory.": "请选择解包目录。",
        "Unpacking audio library...": "正在解包音频库...",
        "Unpack operation cancelled.": "解包操作已取消。",
        "Could not unpack library:": "无法解包音频库:",
        "Library unpacked.": "音频库已解包。",
        "Set file:": ".set 文件:",
        "Audio folder:": "音频文件夹:",
        "Packed": "已打包",
        "Skipped": "已跳过",
