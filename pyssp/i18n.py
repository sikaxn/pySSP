...
_TRANSLATIONS = {
    LANG_ZH_CN: {
        ...
        "Manual start": "手动启动",
        "Auto when enabled": "启用时自动连接",
        "Connect on open": "打开窗口时连接",
        "Grid Columns:": "网格列数:",
        "Grid Rows:": "网格行数:",
        "Grid Size": "网格大小",
        "Start": "启动",
        "Stop": "停止",
        "Reconnect": "重新连接",
        "pySSP will connect to Companion's Satellite API as one virtual surface and render the configured grid.": "pySSP 将通过一个虚拟表面连接到 Companion 的 Satellite API，并渲染已配置的网格。",
