...
class SettingsArchiveMixin:
    ...
    def _save_settings(self) -> None:
        ...
        self.settings.stage_display_font_family = self.stage_display_font_family
        self.settings.stage_display_font_size = int(self.stage_display_font_size)
        self.settings.stage_display_lyric_font_family = self.stage_display_lyric_font_family
        self.settings.stage_display_lyric_font_size = int(self.stage_display_lyric_font_size)
        self.settings.stage_display_lyric_previous_line_count = int(self.stage_display_lyric_previous_line_count)
        self.settings.stage_display_lyric_next_line_count = int(self.stage_display_lyric_next_line_count)
        self.settings.stage_display_lyric_played_color = self.stage_display_lyric_role_colors.get("played", "#A0A0A0")
        self.settings.stage_display_lyric_current_color = self.stage_display_lyric_role_colors.get("current", "#FFD400")
        self.settings.stage_display_lyric_next_color = self.stage_display_lyric_role_colors.get("next", "#FFFFFF")
        self.settings.stage_display_lyric_auto_adjust_role_sizes = bool(self.stage_display_lyric_auto_adjust_role_sizes)
        self.settings.stage_display_lyric_played_scale_percent = int(self.stage_display_lyric_role_scale_percents.get("played", 70))
        self.settings.stage_display_lyric_current_scale_percent = int(self.stage_display_lyric_role_scale_percents.get("current", 115))
        self.settings.stage_display_lyric_next_scale_percent = int(self.stage_display_lyric_role_scale_percents.get("next", 90))
        self.settings.stage_display_lyric_played_text_size = int(self.stage_display_lyric_role_sizes.get("played", 18))
        self.settings.stage_display_lyric_current_text_size = int(self.stage_display_lyric_role_sizes.get("current", 28))
        self.settings.stage_display_lyric_next_text_size = int(self.stage_display_lyric_role_sizes.get("next", 22))
        self.settings.stage_display_lyric_played_bold = bool(self.stage_display_lyric_role_bold.get("played", True))
        self.settings.stage_display_lyric_current_bold = bool(self.stage_display_lyric_role_bold.get("current", True))
        self.settings.stage_display_lyric_next_bold = bool(self.stage_display_lyric_role_bold.get("next", True))
        self.settings.stage_display_lyric_played_italic = bool(self.stage_display_lyric_role_italic.get("played", False))
        self.settings.stage_display_lyric_current_italic = bool(self.stage_display_lyric_role_italic.get("current", False))
        ...
        self.settings.lyric_display_next_line_count = int(self.lyric_display_next_line_count)
        self.settings.lyric_display_played_color = self.lyric_display_role_colors.get("played", "#A0A0A0")
        self.settings.lyric_display_current_color = self.lyric_display_role_colors.get("current", "#FFD400")
        self.settings.lyric_display_next_color = self.lyric_display_role_colors.get("next", "#FFFFFF")
        self.settings.lyric_display_auto_adjust_role_sizes = bool(self.lyric_display_auto_adjust_role_sizes)
        self.settings.lyric_display_played_scale_percent = int(self.lyric_display_role_scale_percents.get("played", 70))
        self.settings.lyric_display_current_scale_percent = int(self.lyric_display_role_scale_percents.get("current", 115))
        self.settings.lyric_display_next_scale_percent = int(self.lyric_display_role_scale_percents.get("next", 90))
        self.settings.lyric_display_played_text_size = int(self.lyric_display_role_sizes.get("played", 24))
        self.settings.lyric_display_current_text_size = int(self.lyric_display_role_sizes.get("current", 40))
        self.settings.lyric_display_next_text_size = int(self.lyric_display_role_sizes.get("next", 32))
        self.settings.lyric_display_played_bold = bool(self.lyric_display_role_bold.get("played", True))
        self.settings.lyric_display_current_bold = bool(self.lyric_display_role_bold.get("current", True))
        self.settings.lyric_display_next_bold = bool(self.lyric_display_role_bold.get("next", True))
        ...
        self.settings.sound_button_view_mode = str(getattr(self, "sound_button_view_mode", "grid") or "grid").strip().lower()
        self.settings.sound_button_grid_columns = max(1, int(getattr(self, "sound_button_grid_columns", 8)))
