...
class UiBuildMixin:
    ...
    def _build_menu_bar(self) -> None:
        ...
        lyric_display_setting_action = QAction("Lyric Display Setting", self)
        lyric_display_setting_action.triggered.connect(lambda: self._open_options_dialog(initial_page="Lyric"))
        display_menu.addAction(lyric_display_setting_action)
