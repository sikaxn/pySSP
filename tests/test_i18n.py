...
class TestI18n(unittest.TestCase):
    ...
    def test_translate_known_text(self):
        ...
        self.assertEqual(translate_text("Window", LANG_ZH_CN), "窗口")
        self.assertEqual(translate_text("Video Display", LANG_ZH_CN), "视频显示")
        self.assertEqual(translate_text("Routing Defaults", LANG_ZH_CN), "路由默认值")
        self.assertEqual(translate_text("Do not load video", LANG_ZH_CN), "不加载视频")
        self.assertEqual(translate_text("Follow Sound Button Display Focus", LANG_ZH_CN), "跟随声音按钮显示焦点")
        self.assertEqual(translate_text("Bold", LANG_ZH_CN), "粗体")
