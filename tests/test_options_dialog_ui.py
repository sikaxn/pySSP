...
def _build_dialog(**overrides):
    ...
    return OptionsDialog(
        ...
        audio_output_device="",
        vst_enabled=defaults["vst_enabled"],
        vst_directories=defaults["vst_directories"],
        vst_known_plugins=defaults["vst_known_plugins"],
        vst_enabled_plugins=defaults["vst_enabled_plugins"],
        vst_chain=defaults["vst_chain"],
        vst_plugin_state=defaults["vst_plugin_state"],
        ...
        midi_sound_button_hotkey_enabled=bool(overrides.get("midi_sound_button_hotkey_enabled", False)),
        midi_sound_button_hotkey_priority=str(overrides.get("midi_sound_button_hotkey_priority", "system_first")),
        midi_sound_button_hotkey_go_to_playing=bool(overrides.get("midi_sound_button_hotkey_go_to_playing", False)),
        midi_rotary_enabled=bool(overrides.get("midi_rotary_enabled", False)),
        midi_rotary_group_binding=str(overrides.get("midi_rotary_group_binding", "")),
        midi_rotary_page_binding=str(overrides.get("midi_rotary_page_binding", "")),
        midi_rotary_sound_button_binding=str(overrides.get("midi_rotary_sound_button_binding", "")),
        midi_rotary_jog_binding=str(overrides.get("midi_rotary_jog_binding", "")),
        midi_rotary_volume_binding=str(overrides.get("midi_rotary_volume_binding", "")),
        midi_rotary_group_invert=bool(overrides.get("midi_rotary_group_invert", False)),
        midi_rotary_page_invert=bool(overrides.get("midi_rotary_page_invert", False)),
        midi_rotary_sound_button_invert=bool(overrides.get("midi_rotary_sound_button_invert", False)),
        midi_rotary_jog_invert=bool(overrides.get("midi_rotary_jog_invert", False)),
        midi_rotary_volume_invert=bool(overrides.get("midi_rotary_volume_invert", False)),
        midi_rotary_group_sensitivity=int(overrides.get("midi_rotary_group_sensitivity", 1)),
        midi_rotary_page_sensitivity=int(overrides.get("midi_rotary_page_sensitivity", 1)),
        midi_rotary_sound_button_sensitivity=int(overrides.get("midi_rotary_sound_button_sensitivity", 1)),
        midi_rotary_group_relative_mode=str(overrides.get("midi_rotary_group_relative_mode", "auto")),
        midi_rotary_page_relative_mode=str(overrides.get("midi_rotary_page_relative_mode", "auto")),
        midi_rotary_sound_button_relative_mode=str(overrides.get("midi_rotary_sound_button_relative_mode", "auto")),
        midi_rotary_jog_relative_mode=str(overrides.get("midi_rotary_jog_relative_mode", "auto")),
        midi_rotary_volume_relative_mode=str(overrides.get("midi_rotary_volume_relative_mode", "auto")),
